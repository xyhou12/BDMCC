...
x = 5*xx(1:160000)';
% [x,PS] = mapstd(x);
near_end = [zeros(1,40000) xx(40001:60000)' zeros(1,60000) xx(40001:60000)' zeros(1,20000)];%%近端语音
...
for k = L+P:iter
    ...
    y = x_input'*w;
    e = d_noise(k) - y;
    Xs = x_input*exp(-e^2/(2*sigma^2))*e;
    w = w + mu*Xs;
    if k <= iter/2
...
% 
NMSD_MCC = NMSD;
save MCC.mat NMSD_MCC
% NMSD_LMS = NMSD;
% save LMS.mat NMSD_LMS