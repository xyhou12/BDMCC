...
% l1 = legend('MCC(\sigma = 1, \mu = 0.005)','NMCC(\sigma = 1, \mu = 0.25)','APMCC({\itP} = 2, \sigma = 1, \mu = 0.15)',['BDMCC({\itM} = 2, \sigma_{1} = \sigma_{2} = 4, ' newline '\lambda_{\itq} = 0.999996, \lambda_{\itz} = 0.9999, \lambda_{\itv} = 0.99999)'],'Near-end speech');
l1 = legend('MCC','NMCC','APMCC','BDMCC','Near-end speech');
